...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const voltzVaultParams = [[
        tokens, // tokens
        deployer, // 
        marginEngines['borrow_cUSDT_v1'], // margin engine
        voltzVaultHelper, // voltz vault helper singleton
        vaultInitialParamDict['borrow_cUSDT_v1'], // initial parameters
    ]];
    ...
    const vaultStrategyParams = [vaultStrategyParamDict['borrow_cUSDT_v1']];
