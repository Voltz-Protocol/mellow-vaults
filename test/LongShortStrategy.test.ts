...
import { ERC20Vault, IMarginEngine, IVAMM, LongShortStrategy, VoltzVault } from "./types";
...
contract<LongShortStrategy, DeployOptions, CustomContext>("LongShortStrategy", function () {
    this.timeout(200000);
